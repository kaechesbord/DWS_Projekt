// src/pages/Klavijature.jsx
import React from 'react';
import Navbar from '../components/Navbar';
import { useCart } from '../context/CartContext'; // Uvoz useCart

// --- Uvoz slika ---
// PAŽNJA: Provjerite da li su ove putanje do slika TOČNE u vašem projektu!
...
// Definisanje podataka za klavijature
const klavijatureData = [ // Pravilan naziv varijable
  {
    id: 1,
...
export default function Klavijature() {
  const { addToCart } = useCart(); // Dohvaćamo addToCart iz globalnog konteksta
    ...
    <>
      ...
      <div className="container mx-auto px-20 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {/* OVDJE JE PROMJENA: Koristimo klavijatureData umjesto keyboardsData */}
          {klavijatureData.map(keyboard => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow relative z-10 bg-white rounded-b-lg">
                ...
                <button
                  onClick={() => addToCart(keyboard)} // Pozivamo globalnu addToCart funkciju
